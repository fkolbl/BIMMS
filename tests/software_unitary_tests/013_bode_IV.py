...
plt.legend()
plt.savefig('./software_unitary_tests/figures_software/013_bode_IV_V_readout.png')
plt.close("all")
...
plt.legend()
plt.savefig('./software_unitary_tests/figures_software/013_bode_IV_I_readout.png')
plt.close("all")
