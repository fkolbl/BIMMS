...
bimms.set_state(bm.cst.STM32_idle)
time.sleep(0.2)
state = bimms.get_state()
if (state == bm.cst.STM32_idle):
...
bimms.set_state(bm.cst.STM32_locked)
time.sleep(0.2)
state = bimms.get_state()
if (state == bm.cst.STM32_locked):
