...
cal_potentiostat_SE_AC = 1
cal_potentiostat_DIFF_DC = 1
cal_potentiostat_DIFF_AC = 1

cal_galvanostat_SE_DC_high_gain = 1
cal_galvanostat_SE_DC_low_gain = 1
cal_galvanostat_SE_AC_high_gain = 1
cal_galvanostat_SE_AC_low_gain = 1
cal_galvanostat_DIFF_DC_high_gain = 1
cal_galvanostat_DIFF_DC_low_gain = 1
cal_galvanostat_DIFF_AC_high_gain = 1
cal_galvanostat_DIFF_AC_low_gain = 1
